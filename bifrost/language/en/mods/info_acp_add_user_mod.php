...
$lang = array_merge($lang, array(
	...
	'ADD_USER'					=> 'Add User',
	'ADD_USER_EXPLAIN'			=> 'Create a new user account. If your activation settings are set to Admin Activativation only, you will have the option to activate the user instantly.',
	'ADMIN_ACTIVATE'			=> 'Activate user account',
	'CONFIRM_PASSWORD'			=> 'Confirm password',
	'EDIT_USER_GROUPS'			=> '%1$sClick here to manage the groups of %2$s%3$s',

	'CONTINUE_EDIT_USER'		=> '%1$sClick here to manage the profile of %2$s%3$s', // e.g.: Click here to manage the profile of Joe.
